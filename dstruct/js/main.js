// EDU-ALGO · dstruct floor — orchestrator. Wires the DOM-free structure engine to
...
// Verification is synchronous — building a handful of small structures is cheap.
...
import { createStructView } from './ui/structView.js';
...
const structView = createStructView(document.getElementById('structView'));
